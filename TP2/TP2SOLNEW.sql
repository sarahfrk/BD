...
--des privileges system donc je connecte avec le systeme pour les enlever
connect system/psw  --avec le system 
--privilège système
...
--des privileges objet donc je connecte avec dbaintervention pour les enlever
connect dbaintervention/psw
--privilège objet
...
connect admin/admin;
select * from user_objects; //pour afficher les tables cree par l utilisateur admin
--la commande de suppression d un profile
DROP PROFILE Interv_Profil CASCADE;