...
-- pour pouvoir créer un utilisateur sur oracle 19c: Alter session set "_oracle_script"=true; --
...
select constraint_name, constraint_type from user_constraints where table_name='EMPLOYE'; --afficher les contraintes de la table emplye de l'utilisateur dbaintervention à partir de la vue user_constraints
